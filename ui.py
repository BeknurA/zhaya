...
LANG = {
    ...
    "ru": {
        ...
        "menu_digital_technologies": "Цифровые технологии",
        "digital_technologies_title": "Анализ современных цифровых технологий контроля и безопасности",
        "digital_technologies_intro": "В данном разделе представлены результаты исследования современных цифровых технологий, применяемых для контроля и обеспечения безопасности в пищевой промышленности, в частности в мясной индустрии.",
        "digital_technologies_research_title": "1. Исследование цифровых технологий контроля",
        "digital_technologies_sensors_title": "Сенсоры и датчики",
        "digital_technologies_temp_sensors_title": "Сенсоры температуры",
        "digital_technologies_temp_sensors_purpose": "- **Назначение**: Контроль температуры на всех этапах производства, от приемки сырья до хранения готовой продукции.",
        "digital_technologies_temp_sensors_examples": "- **Примеры**: Термопары, терморезисторы, инфракрасные датчики.",
        "digital_technologies_temp_sensors_criteria": "- **Критерии выбора**:",
        "digital_technologies_temp_sensors_cost": "- **Стоимость**: Варьируется от бюджетных до дорогостоящих моделей.",
        "digital_technologies_temp_sensors_accuracy": "- **Точность**: Высокая точность критична для соблюдения технологических режимов.",
        "digital_technologies_temp_sensors_applicability": "- **Применимость**: Бесконтактные ИК-датчики удобны для движущихся объектов, контактные — для измерения внутри продукта.",
        "digital_technologies_humidity_sensors_title": "Сенсоры влажности",
        "digital_technologies_humidity_sensors_purpose": "- **Назначение**: Измерение относительной влажности воздуха в производственных и складских помещениях.",
        "digital_technologies_humidity_sensors_examples": "- **Примеры**: Емкостные, резистивные, психрометрические датчики.",
        "digital_technologies_humidity_sensors_criteria": "- **Критерии выбора**:",
        "digital_technologies_humidity_sensors_cost": "- **Стоимость**: Умеренная.",
        "digital_technologies_humidity_sensors_accuracy": "- **Точность**: Важна для предотвращения развития микроорганизмов.",
        "digital_technologies_humidity_sensors_applicability": "- **Применимость**: Широко используются в камерах созревания и хранения.",
        "digital_technologies_ph_sensors_title": "Сенсоры pH",
        "digital_technologies_ph_sensors_purpose": "- **Назначение**: Контроль кислотности продукта, что влияет на его вкусовые качества и срок хранения.",
        "digital_technologies_ph_sensors_examples": "- **Примеры**: Электродные pH-метры, в том числе с проникающими зондами.",
        "digital_technologies_ph_sensors_criteria": "- **Критерии выбора**:",
        "digital_technologies_ph_sensors_cost": "- **Стоимость**: Выше, чем у датчиков температуры/влажности.",
        "digital_technologies_ph_sensors_accuracy": "- **Точность**: Критически важна для управления процессами ферментации и созревания.",
        "digital_technologies_ph_sensors_applicability": "- **Применимость**: Необходимы для лабораторий и производственных линий.",
        "digital_technologies_aw_sensors_title": "Сенсоры активности воды (aw)",
        "digital_technologies_aw_sensors_purpose": "- **Назначение**: Оценка доступной для микроорганизмов воды, ключевой показатель для определения срока годности.",
        "digital_technologies_aw_sensors_examples": "- **Примеры**: Датчики на основе точки росы.",
        "digital_technologies_aw_sensors_criteria": "- **Критерии выбора**:",
        "digital_technologies_aw_sensors_cost": "- **Стоимость**: Высокая.",
        "digital_technologies_aw_sensors_accuracy": "- **Точность**: Очень высокая.",
        "digital_technologies_aw_sensors_applicability": "- **Применимость**: Лабораторный контроль качества.",
        "digital_technologies_bio_sensors_title": "Биосенсоры для определения микроорганизмов",
        "digital_technologies_bio_sensors_purpose": "- **Назначение**: Быстрое обнаружение патогенных бактерий (сальмонелла, листерия).",
        "digital_technologies_bio_sensors_examples": "- **Примеры**: Биолюминесцентные, иммуноферментные сенсоры.",
        "digital_technologies_bio_sensors_criteria": "- **Критерии выбора**:",
        "digital_technologies_bio_sensors_cost": "- **Стоимость**: Очень высокая.",
        "digital_technologies_bio_sensors_accuracy": "- **Точность**: Высокая, позволяет сократить время анализа с дней до часов.",
        "digital_technologies_bio_sensors_applicability": "- **Применимость**: Входной контроль сырья, контроль чистоты оборудования.",
        "digital_technologies_iot_title": "IoT-датчики и IIoT-решения",
        "digital_technologies_iot_purpose": "- **Назначение**: Объединение всех сенсоров в единую сеть для сбора, передачи и анализа данных в реальном времени.",
        "digital_technologies_iot_technologies": "- **Технологии**: Беспроводные датчики (LoRaWAN, NB-IoT), облачные платформы (IIoT).",
        "digital_technologies_iot_advantages": "- **Преимущества**:",
        "digital_technologies_iot_monitoring": "- **Централизованный мониторинг**: Все данные доступны на одном экране.",
        "digital_technologies_iot_forecasting": "- **Прогнозирование**: Алгоритмы машинного обучения могут предсказывать сбои оборудования или отклонения в процессе.",
        "digital_technologies_iot_automation": "- **Автоматизация**: Возможность автоматического регулирования параметров (например, температуры в камере).",
        "digital_technologies_iot_criteria": "- **Критерии выбора**:",
        "digital_technologies_iot_cost": "- **Стоимость**: Высокие начальные инвестиции, но быстрая окупаемость за счет снижения брака.",
        "digital_technologies_iot_scalability": "- **Масштабируемость**: Важно выбирать платформу, которую можно расширять.",
        "digital_technologies_iot_integration": "- **Интеграция**: Совместимость с существующим оборудованием.",
        "digital_technologies_scada_title": "SCADA-системы",
        "digital_technologies_scada_purpose": "- **Назначение**: Диспетчерское управление и сбор данных (Supervisory Control And Data Acquisition).",
        "digital_technologies_scada_difference": "- **Отличие от IIoT**: SCADA больше ориентирована на локальное управление процессами в реальном времени, в то время как IIoT — на сбор и анализ больших данных в облаке.",
        "digital_technologies_scada_applicability": "- **Применимость**: Управление конвейерными линиями, системами климат-контроля, упаковочным оборудованием.",
        "digital_technologies_scada_criteria": "- **Критерии выбора**:",
        "digital_technologies_scada_reliability": "- **Надежность**: Системы должны работать бесперебойно 24/7.",
        "digital_technologies_scada_security": "- **Безопасность**: Защита от несанкционированного доступа.",
        "digital_technologies_scada_visualization": "- **Визуализация**: Интуитивно понятный интерфейс для операторов.",
        "digital_technologies_relevant_tech_title": "2. Перечень наиболее актуальных технологий",
        "digital_technologies_relevant_tech_item1": "1. **Беспроводные IoT-сенсоры температуры и влажности**: Для комплексного мониторинга складов и производственных цехов.",
        "digital_technologies_relevant_tech_item2": "2. **Онлайн pH-метры**: Для встраивания непосредственно в производственные линии (например, в куттеры или массажеры).",
        "digital_technologies_relevant_tech_item3": "3. **IIoT-платформы**: Для сбора данных со всех датчиков, их анализа и интеграции с ERP-системами предприятия.",
        "digital_technologies_relevant_tech_item4": "4. **Портативные биосенсоры**: Для экспресс-анализа на микробиологическую чистоту на местах.",
        "digital_technologies_criteria_title": "3. Обоснование критериев выбора",
        "digital_technologies_criteria_cost": "- **Стоимость**: Первоначальные инвестиции должны соотноситься с экономическим эффектом от снижения брака, повышения качества и увеличения срока годности продукции.",
        "digital_technologies_criteria_accuracy": "- **Точность**: Для ключевых параметров (температура, pH) точность является неснижаемым требованием, так как от этого напрямую зависит безопасность продукта.",
        "digital_technologies_criteria_applicability": "- **Применимость**: Выбираемые технологии должны легко интегрироваться в существующие производственные процессы, не требуя их кардинальной перестройки. Важна также простота обслуживания и калибровки датчиков.",
        "digital_technologies_report_title": "4. Обзорный аналитический отчёт",
        "digital_technologies_report_conclusion": "**Вывод:**",
        "digital_technologies_report_recommendation": "Наиболее перспективным направлением является **поэтапное внедрение IIoT-решений**.",
        "digital_technologies_report_stage1": "- **Этап 1**: Установка беспроводных датчиков температуры и влажности на ключевых участках.",
        "digital_technologies_report_stage2": "- **Этап 2**: Интеграция онлайн pH-метров и других специализированных сенсоров.",
        "digital_technologies_report_stage3": "- **Этап 3**: Развертывание облачной IIoT-платформы для сбора и анализа данных.",
        "digital_technologies_report_summary": "Такой подход позволит распределить инвестиции во времени, постепенно обучать персонал и получать измеримый экономический эффект на каждом этапе.",
        "digital_technologies_report_disclaimer": "Данный отчет носит рекомендательный характер и требует дальнейшей проработки с учетом специфики конкретного предприятия.",
